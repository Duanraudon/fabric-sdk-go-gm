...
[![Release](https://img.shields.io/github/release/hyperledger/fabric-sdk-go.svg?style=flat-square)](https://github.com/Duanraudon/fabric-sdk-go-gm/releases/latest)
...
[![GoDoc](https://godoc.org/github.com/Duanraudon/fabric-sdk-go-gm?status.svg)](https://godoc.org/github.com/Duanraudon/fabric-sdk-go-gm)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/Duanraudon/fabric-sdk-go-gm)](https://goreportcard.com/report/github.com/Duanraudon/fabric-sdk-go-gm)
...
```bash
go get github.com/Duanraudon/fabric-sdk-go-gm
```
...
SDK documentation can be viewed at [GoDoc](https://godoc.org/github.com/Duanraudon/fabric-sdk-go-gm).
...
```bash
git clone https://github.com/Duanraudon/fabric-sdk-go-gm.git
```
