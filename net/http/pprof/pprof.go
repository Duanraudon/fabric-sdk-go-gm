...
// need to start one. Add "github.com/Duanraudon/fabric-sdk-go-gm/net/http" and "log" to your imports and
...
import (
	...
	"github.com/Duanraudon/fabric-sdk-go-gm/net/http/internal/profile"
