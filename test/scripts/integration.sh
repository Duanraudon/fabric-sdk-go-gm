...
#       grep -v ^${PROJECT_MODULE}/test/integration/pkg/client | \
#       grep -v ^${PROJECT_MODULE}/test/integration/negative | \
#       grep -v ^${PROJECT_MODULE}/test/integration\$ | \
#       tr '\n' ' '))

    #   PKGS=($(${GO_CMD} list ${PROJECT_MODULE}/test/integration/pkg/client/... 2> /dev/null | \
    #  tr '\n' ' '))
  PKGS=($(${GO_CMD} list ${PROJECT_MODULE}/test/integration/pkg/client/common/selection... 2> /dev/null | \
 tr '\n' ' '))
