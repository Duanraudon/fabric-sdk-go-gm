...
const (
	channelID         = "myChannel"
	peerTLSServerCert = "${FABRIC_SDK_GO_PROJECT_PATH}/test/fixtures/fabric/v2/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/server.crt"
	peerTLSServerKey  = "${FABRIC_SDK_GO_PROJECT_PATH}/test/fixtures/fabric/v2/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/server.key"

	ordererTLSServerCert = "${FABRIC_SDK_GO_PROJECT_PATH}/test/fixtures/fabric/v2/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tls/server.crt"
	ordererTLSServerKey  = "${FABRIC_SDK_GO_PROJECT_PATH}/test/fixtures/fabric/v2/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tls/server.key"
