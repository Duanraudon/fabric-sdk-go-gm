...
import (
	...
	bccspSw "github.com/Duanraudon/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric/bccsp/factory/sw"
	"github.com/Duanraudon/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric/bccsp/sw"
	...
	"github.com/Duanraudon/fabric-sdk-go-gm/pkg/core/cryptosuite/bccsp/wrapper"
	"github.com/pkg/errors"
)

var logger = logging.NewLogger("fabsdk/core")

// SWSecAlgo is Security Hash Algo in config file
var SWSecAlgo string
...
func getEphemeralOpts() *bccspSw.SwOpts {
	opts := &bccspSw.SwOpts{
		//use SecAlgo in config file
		// HashFamily: cryptosuite.SecAlgo,
		HashFamily: "SHA2",
		SecLevel:   256,
		Ephemeral:  false,
	}
