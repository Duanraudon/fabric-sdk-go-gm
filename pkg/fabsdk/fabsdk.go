...
import (
	...
	"github.com/Duanraudon/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric/core/operations"
	"github.com/Duanraudon/fabric-sdk-go-gm/pkg/common/logging"
	coptions "github.com/Duanraudon/fabric-sdk-go-gm/pkg/common/options"
	contextApi "github.com/Duanraudon/fabric-sdk-go-gm/pkg/common/providers/context"
	...
	"github.com/Duanraudon/fabric-sdk-go-gm/pkg/core/logging/api"
	fabImpl "github.com/Duanraudon/fabric-sdk-go-gm/pkg/fab"
	sdkApi "github.com/Duanraudon/fabric-sdk-go-gm/pkg/fabsdk/api"
	"github.com/Duanraudon/fabric-sdk-go-gm/pkg/fabsdk/metrics"
	metricsCfg "github.com/Duanraudon/fabric-sdk-go-gm/pkg/fabsdk/metrics/cfg"
	mspImpl "github.com/Duanraudon/fabric-sdk-go-gm/pkg/msp"
...
func (sdk *FabricSDK) initializeCryptoSuite(cryptoSuiteConfig core.CryptoSuiteConfig) error {
	...
	if !cryptosuite.DefaultInitialized() {
		err = cryptosuite.SetDefault(sdk.cryptoSuite, cryptoSuiteConfig.SecurityAlgorithm())
		if err != nil {
