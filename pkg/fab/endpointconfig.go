...
import (
	...
	commtls "github.com/Duanraudon/fabric-sdk-go-gm/pkg/core/config/comm/tls"
	"github.com/Duanraudon/fabric-sdk-go-gm/pkg/core/config/cryptoutil"
	...
	"github.com/Duanraudon/fabric-sdk-go-gm/pkg/util/pathvar"
...
func detectDeprecatedNetworkConfig(endpointConfig *EndpointConfig) {
	...
	for _, v := range endpointConfig.networkConfig.Channels {
		if len(v.Orderers) > 0 {
			...
			logger.Warn("visit https://github.com/Duanraudon/fabric-sdk-go-gm/blob/master/test/fixtures/config/overrides/local_entity_matchers.yaml for samples")
			break
		}
	}
}
