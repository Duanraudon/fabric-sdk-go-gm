...
import (
	...
	mspcfg "github.com/Duanraudon/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric/msp"
...
func TestGenerateMspDir(t *testing.T) {
	...
	ordererMspDir := filepath.Join(metadata.GetProjectPath(), "test/fixtures/fabric/v2/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/msp")
