...
import (
	...
	"github.com/Duanraudon/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric/core/chaincode/persistence"
	"github.com/Duanraudon/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric/sdkinternal/peer/packaging"
...
func ComputePackageID(label string, pkgBytes []byte) string {
	if cryptosuite.SecAlgo == "SM3" {
		return fmt.Sprintf("%s:%x", label, util.ComputeSM3(pkgBytes))
	}
