...
func (fake *MockTransactor) SendBsnTransaction(tx *fab.Transaction) (*fab.TransactionResponse, error) {
	return nil, nil
}

func (fake *MockTransactor) SendBsnTransactionProposal(arg1 *pb.SignedProposal, arg2 []fab.ProposalProcessor) ([]*fab.TransactionProposalResponse, error) {
	return nil, nil
}
