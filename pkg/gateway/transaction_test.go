...
import (
	...
	cpc "github.com/Duanraudon/fabric-sdk-go-gm/pkg/common/providers/context"
...
func (t *mockTransactor) SendBsnTransactionProposal(arg1 *pb.SignedProposal, arg2 []fab.ProposalProcessor) ([]*fab.TransactionProposalResponse, error) {
	return nil, nil
}
